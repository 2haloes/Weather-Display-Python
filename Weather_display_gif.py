...
class Window(ttk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.currentPhotoImage = PhotoImage(file="images/cloudy.gif")
        ...
        # Sun rise/set vars
        self.risePhotoImage = PhotoImage(file="images_small/sun-rise.gif")
        self.setPhotoImage = PhotoImage(file="images_small/sun-set.gif")

        # Day 0 variables
        self.day0NameText = tk.StringVar()
        self.day0NameText.set("Nul")
        self.day0PhotoImage = PhotoImage(file="images_small/cloudy.gif")
        ...
        self.day1PhotoImage = PhotoImage(file="images_small/cloudy.gif")
        ...
        self.day2PhotoImage = PhotoImage(file="images_small/cloudy.gif")
        ...
        self.day3PhotoImage = PhotoImage(file="images_small/cloudy.gif")
        ...
        self.day4PhotoImage = PhotoImage(file="images_small/cloudy.gif")
...
def VarSet():
    ...
    app.currentPhotoImage = PhotoImage(file="images/"+ content["currently"]["icon"] +".gif")
    ...
    app.day0PhotoImage = PhotoImage(file="images_small/" + content["daily"]["data"][0]["icon"] + ".gif")
    ...
    app.day1PhotoImage = PhotoImage(file="images_small/" + content["daily"]["data"][1]["icon"] + ".gif")
    ...
    app.day2PhotoImage = PhotoImage(file="images_small/" + content["daily"]["data"][2]["icon"] + ".gif")
    ...
    app.day3PhotoImage = PhotoImage(file="images_small/" + content["daily"]["data"][3]["icon"] + ".gif")
    ...
    app.day4PhotoImage = PhotoImage(file="images_small/" + content["daily"]["data"][4]["icon"] + ".gif")
